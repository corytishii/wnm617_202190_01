...
// name for this type of code--an object--the name for writing objects, is json
...
[
  '{{repeat(50)}}',
  {
    ...
    type: '{{random("bird","frog","lizard")}}',
    breed: function(tags) {
      var breeds = {
        bird:["owl","crane","penguin"],
        frog:["glass frog","true frog","tree frog","toad"],
...
[
  '{{repeat(250)}}',
  {
    ...
    lat: '{{floating(37.799305, 37.701274)}}',
    lng: '{{floating(-122.501194, -122.385452)}}',
